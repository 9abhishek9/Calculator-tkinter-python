...
label = tk.Label(mywindow, text="Enter first number", pady=(10))
label.pack()

first_number_entry = tk.Entry(mywindow)
first_number_entry.pack()

label2 = tk.Label(mywindow, text="Enter second number")
label2.pack()

second_number_entry = tk.Entry(mywindow)
second_number_entry.pack()

operations = tk.Label(mywindow, text="Operations")
operations.pack()
...
addition_button = tk.Button(mywindow, text="+",
                            command=lambda : addition())
addition_button.pack()

minus_button = tk.Button(mywindow, text="-",
                         command=lambda : subtract())
minus_button.pack()

multiply_button = tk.Button(mywindow, text="*",
                            command=lambda : multiply())
multiply_button.pack()

division_button = tk.Button(mywindow, text="/",
                            command=lambda : divide())
division_button.pack()

result_label = tk.Label(mywindow, text="Operations result is:")
result_label.pack()
